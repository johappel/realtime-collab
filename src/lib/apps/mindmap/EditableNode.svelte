...
>
    ...
    <div
        class="absolute -top-5 left-0 right-0 flex justify-center items-center h-4 cursor-grab active:cursor-grabbing opacity-0 group-hover:opacity-100 transition-opacity duration-200"
        class:opacity-100={selected}
    >
        <div
            class="w-16 h-1.5 rounded-full shadow-sm transition-colors duration-200"
    ...
    <div class="flex flex-col gap-1">
        ...
        {#if data.imageUrl && data.imageIv}
            <div class="mt-2 flex justify-center nodrag">
                <EncryptedImage
                    src={data.imageUrl}
                    iv={data.imageIv}
